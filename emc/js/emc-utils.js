...
// ─── جدول الكوهورت التفصيلي (6 أيام · جمعة وسبت × 3 أسابيع · 10ص–6م) ───
window.EMC.COHORT_SCHEDULE = [
  {
    day: 1, weekday: 'الجمعة', week: 1, pillar: 'الرؤية',
    outcome: 'تطلع بمسوّدة واضحة لوجهة شركتك على صفحة واحدة — تشاركها مع فريقك.',
    mission: 'شارك مسوّدة الرؤية مع فريق قيادتك واسمع ردّهم قبل اليوم الجاي.',
    sessions: [
      { t: '10:00 – 10:30', title: 'افتتاح الرحلة', d: 'تعارف، قواعد الـ 6 أيام، وإزاي هنشتغل سوا على شركتك إنت بالذات.' },
      { t: '10:30 – 12:00', title: 'ليه نبدأ بالرؤية؟', d: 'العربية اللي مش عارفة رايحة فين بتلف في مكانها — الوضوح هو أول وأهم خطوة.' },
      { t: '12:00 – 12:15', title: 'استراحة', break: true },
      { t: '12:15 – 1:45', title: 'ورشة: قيم شركتك الأساسية', d: 'مين إنتوا فعلاً، وإيه المبادئ اللي مش بتتنازلوا عنها مهما حصل.' },
      { t: '1:45 – 2:45', title: 'غداء وصلاة', break: true },
      { t: '2:45 – 4:15', title: 'السبب الجوهري + هدف الـ 10 سنين', d: 'ليه شركتك موجودة أصلاً، وإيه الوجهة البعيدة اللي ماشي ناحيتها.' },
      { t: '4:15 – 4:30', title: 'استراحة', break: true },
      { t: '4:30 – 5:30', title: 'ورشة: صورة الـ 3 سنين', d: 'تحدّد شكل الشركة اللي عايز توصلها خلال 3 سنين بوضوح ملموس.' },
      { t: '5:30 – 6:00', title: 'ختام اليوم + مهمة الأسبوع', d: 'نلخّص اليوم، ونحدّد شغل التطبيق اللي هتعمله قبل ما نتقابل تاني.' }
    ]
  },
  {
    day: 2, weekday: 'السبت', week: 1, pillar: 'الناس',
    outcome: 'تطلع بخريطة واضحة لمين مسؤول عن إيه، وتشخيص لمين في الدور الصح ومين لأ.',
    mission: 'راجع خريطة المسؤوليات مع شريكك أو نائبك، وحدّد أي دور ناقص أو مكرّر.',
    sessions: [
      { t: '10:00 – 10:30', title: 'افتتاح + استرجاع', d: 'مراجعة سريعة لرؤية امبارح وأي ملاحظات طلعت من مشاركتها مع الفريق.' },
      { t: '10:30 – 12:00', title: 'الناس الصح في الأماكن الصح', d: 'الفرق بين إنك تشتغل بالناس المتاحة، وإنك تبني فريق متناسق ومتكامل.' },
      { t: '12:00 – 12:15', title: 'استراحة', break: true },
      { t: '12:15 – 1:45', title: 'ورشة: خريطة المسؤوليات', d: 'مين مسؤول عن إيه فعلاً في شركتك — بعيداً عن المسميات الرسمية.' },
      { t: '1:45 – 2:45', title: 'غداء وصلاة', break: true },
      { t: '2:45 – 4:15', title: 'الشخص المناسب للدور المناسب', d: 'تشخيص عملي: مين بيشارك قيم الشركة، ومين فعلاً في المكان الصح له.' },
      { t: '4:15 – 4:30', title: 'استراحة', break: true },
      { t: '4:30 – 5:30', title: 'ورشة: المحادثات المؤجلة', d: 'القرارات الصعبة في الفريق اللي بتأجّلها — وإزاي تتعامل معاها.' },
      { t: '5:30 – 6:00', title: 'ختام اليوم + مهمة الأسبوع', d: 'نلخّص، ونحدّد خطوة التطبيق على محور الناس قبل الأسبوع الجاي.' }
    ]
  },
  {
    day: 3, weekday: 'الجمعة', week: 2, pillar: 'البيانات',
    outcome: 'تطلع بلوحة أرقام أسبوعية (من 5 لـ 15 رقم) بتقولك صحة شركتك في لمحة.',
    mission: 'شغّل كارت الأرقام أسبوع كامل، وراقب أي رقم بيكشفلك حاجة ما كنتش واخد بالك منها.',
    sessions: [
      { t: '10:00 – 10:30', title: 'افتتاح + مراجعة تطبيق الأسبوع الأول', d: 'إيه اللي اتطبّق من الرؤية والناس، وإيه العقبات اللي ظهرت.' },
      { t: '10:30 – 12:00', title: 'الأرقام اللي بتقول الحقيقة', d: 'إزاي تشوف المشكلة في الأرقام قبل ما تتفجّر في الواقع وتكلّفك.' },
      { t: '12:00 – 12:15', title: 'استراحة', break: true },
      { t: '12:15 – 1:45', title: 'ورشة: اختار أرقامك الحاكمة', d: 'الـ 5 لـ 15 رقم اللي بيحكموا صحة شركتك فعلاً — مش كل رقم متاح.' },
      { t: '1:45 – 2:45', title: 'غداء وصلاة', break: true },
      { t: '2:45 – 4:15', title: 'الرقم الشخصي', d: 'لكل واحد في الفريق رقم بيمتلكه — المساءلة بتبقى بالأرقام مش بالكلام.' },
      { t: '4:15 – 4:30', title: 'استراحة', break: true },
      { t: '4:30 – 5:30', title: 'ورشة: ابني كارت أرقامك الأسبوعي', d: 'لوحة واحدة تبصّ عليها كل أسبوع وتعرف إنت كويس ولا فيه مشكلة جاية.' },
      { t: '5:30 – 6:00', title: 'ختام اليوم + مهمة الأسبوع', d: 'تشغّل الكارت فعلياً وتجمع أول قراءة أسبوعية.' }
    ]
  },
  {
    day: 4, weekday: 'السبت', week: 2, pillar: 'القضايا',
    outcome: 'تتعلم طريقة منظّمة تحسم بيها أي مشكلة من جذرها — وتطبّقها على أكبر مشاكلك دلوقتي.',
    mission: 'طبّق طريقة الحسم (حدّد · ناقش · احسم) في أول اجتماع قيادة جاي.',
    sessions: [
      { t: '10:00 – 10:30', title: 'افتتاح + استرجاع', d: 'مراجعة كارت الأرقام وأي إشارات كشفها في أول أسبوع تشغيل.' },
      { t: '10:30 – 12:00', title: 'ليه نفس المشاكل بترجع؟', d: 'الفرق بين إنك تطفّي الحريق كل مرة، وإنك تحل المشكلة من جذرها مرة واحدة.' },
      { t: '12:00 – 12:15', title: 'استراحة', break: true },
      { t: '12:15 – 1:45', title: 'ورشة: قائمة القضايا', d: 'تطلّع كل اللي بيعطّل شركتك على السطح بصراحة — أول خطوة للحسم.' },
      { t: '1:45 – 2:45', title: 'غداء وصلاة', break: true },
      { t: '2:45 – 4:15', title: 'طريقة الحسم: حدّد · ناقش · احسم', d: 'تدريب حيّ على حسم مشكلة حقيقية من شركتك خطوة بخطوة.' },
      { t: '4:15 – 4:30', title: 'استراحة', break: true },
      { t: '4:30 – 5:30', title: 'ورشة: احسم أكبر 3 قضايا', d: 'شغل فعلي على أهم 3 مشاكل بتقلقك دلوقتي — لحد قرار واضح.' },
      { t: '5:30 – 6:00', title: 'ختام اليوم + مهمة الأسبوع', d: 'تنقل الطريقة لاجتماع فريقك وتطبّقها على قضية حقيقية.' }
    ]
  },
  {
    day: 5, weekday: 'الجمعة', week: 3, pillar: 'العمليات',
    outcome: 'توثّق أهم عمليات شركتك في خطوات بسيطة يقدر أي حد يمشي عليها.',
    mission: 'وثّق باقي عملياتك الأساسية مع المسؤول عن كل واحدة فيهم.',
    sessions: [
      { t: '10:00 – 10:30', title: 'افتتاح + مراجعة تطبيق الأسبوع التاني', d: 'إيه اللي اتحسم من القضايا، وإزاي اشتغلت طريقة الحسم مع الفريق.' },
      { t: '10:30 – 12:00', title: 'الطريقة الموحّدة', d: 'لما كل واحد بيشتغل بمزاجه، النتيجة بتختلف كل مرة — والعميل بيحس بده.' },
      { t: '12:00 – 12:15', title: 'استراحة', break: true },
      { t: '12:15 – 1:45', title: 'ورشة: حدّد عملياتك الأساسية', d: 'الـ 6 لـ 10 عمليات اللي بتشغّل شركتك فعلاً وبتحدّد جودتها.' },
      { t: '1:45 – 2:45', title: 'غداء وصلاة', break: true },
      { t: '2:45 – 4:15', title: 'توثيق ببساطة', d: 'الـ 20% من الخطوات اللي بتعمل 80% من النتيجة — من غير تعقيد.' },
      { t: '4:15 – 4:30', title: 'استراحة', break: true },
      { t: '4:30 – 5:30', title: 'ورشة: وثّق عملية كاملة', d: 'تطبيق حيّ على عملية واحدة + إزاي تضمن إن الكل ماشي عليها فعلاً.' },
      { t: '5:30 – 6:00', title: 'ختام اليوم + مهمة الأسبوع', d: 'توزّع باقي العمليات على فريقك للتوثيق قبل اليوم الأخير.' }
    ]
  },
  {
    day: 6, weekday: 'السبت', week: 3, pillar: 'الإنجاز + ختام الرحلة',
    outcome: 'تطلع بخطة الـ 90 يوم وإيقاع اجتماعات يخلّي كل اللي اتعلمته يثبت ويتنفّذ فعلاً.',
    mission: 'ابدأ أول دورة 90 يوم بإيقاع اجتماع أسبوعي ثابت — وإحنا معاك في المتابعة.',
    sessions: [
      { t: '10:00 – 10:30', title: 'افتتاح + استرجاع', d: 'مراجعة توثيق العمليات وأي عقبات ظهرت في تطبيقها.' },
      { t: '10:30 – 12:00', title: 'من النوايا للإنجاز', d: 'الانضباط اللي بيحوّل الكلام في الاجتماعات لتنفيذ حقيقي على الأرض.' },
      { t: '12:00 – 12:15', title: 'استراحة', break: true },
      { t: '12:15 – 1:45', title: 'ورشة: أولويات الـ 90 يوم', d: 'تحدّد أهم 3-7 حاجات لو اتعملت في الـ 90 يوم الجاية هتفرق فعلاً.' },
      { t: '1:45 – 2:45', title: 'غداء وصلاة', break: true },
      { t: '2:45 – 4:15', title: 'إيقاع الاجتماع الأسبوعي', d: 'الاجتماع المنتظم اللي بيمسك الـ 6 محاور مع بعض ويخلّي الشركة منضبطة.' },
      { t: '4:15 – 4:30', title: 'استراحة', break: true },
      { t: '4:30 – 5:30', title: 'الصورة الكاملة', d: 'إزاي الـ 6 محاور بيشتغلوا مع بعض كنظام واحد متكامل — مش أجزاء منفصلة.' },
      { t: '5:30 – 6:00', title: 'ختام الرحلة + التطبيق الجاي', d: 'خطة التطبيق بعد البرنامج، وإزاي هنكمّل معاك بالمتابعة المنظّمة.' }
    ]
  }
];
...
// ═══════════════════════════════════════════════════════════════════
// [المرحلة 12] قاموس التطبيق والمتابعة (Implementation)
// ═══════════════════════════════════════════════════════════════════

// نقاط المتابعة الافتراضية (إطار الـ90 يوم) — عبد الله يقدر يضيف عليها
window.EMC.DEFAULT_CHECKINS = [
  { key: 'week_1',   label: 'متابعة الأسبوع الأول',      timing: 'بعد الكوهورت بأسبوع' },
  { key: 'month_1',  label: 'متابعة نهاية الشهر الأول',  timing: 'بعد 30 يوم' },
  { key: 'month_2',  label: 'متابعة الشهر الثاني',       timing: 'بعد 60 يوم' },
  { key: 'month_3',  label: 'متابعة الشهر الثالث',       timing: 'بعد 90 يوم' },
  { key: 'final_90', label: 'المراجعة النهائية (90 يوم)', timing: 'ختام فترة التطبيق' }
];

// الأدوات الأساسية اللي بنتتبّع تطبيقها (أسماء مؤقتة لحد اعتماد لغة EMC)
window.EMC.IMPLEMENTATION_TOOLS = [
  { key: 'accountability', icon: '👥', label: 'خريطة المسؤوليات', hint: 'مين مسؤول عن إيه — الأدوار واضحة ومتطبّقة.' },
  { key: 'weekly_meeting', icon: '🔄', label: 'الاجتماع الأسبوعي', hint: 'اجتماع القيادة المنتظم بقى عادة ثابتة.' },
  { key: 'scorecard',      icon: '📊', label: 'الأرقام والمؤشرات', hint: 'مؤشرات أسبوعية معدودة بيتابعها فعلاً.' },
  { key: 'priorities',     icon: '🎯', label: 'الأولويات (90 يوم)', hint: 'أولويات الفترة محدّدة ومتابَعة.' },
