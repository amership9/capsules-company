/* ============================================================================
   ...
   ── ملاحظة على الترقية (تقرير المشارك العميق) ──────────────────────────────
   اتضافت هنا طبقة محتوى للتقرير الشخصي اللي بيظهر على موبايل المشارك بس
   (مش شاشة العرض): قراءات سردية لكل نوع، ربط كل نوع بمحوره وطريقه، وفقرات
   الطيف/المستوى. ده بيغذّي buildDiagnosticReportHTML في participant.js.
   التقرير الشخصي عمقه مطلوب — لأنه خاص وعلى الموبايل، فمش بيزاحم المقدّم.
...
(function () {
  ...
  /* ====================================================================
     المحاور الثلاثة — مصدر حقيقة واحد (يستخدمه التقرير الشخصي والعرض)
     السؤال اللي شغّال تحت السطح لكل محور — نفس صياغة مرحلة المحاور.
     ==================================================================== */
  var AXES = {
    cohesion:  { key: 'cohesion',  ar: 'التماسك', en: 'Cohesion',
                 question: 'هل أنا بخير وآمن؟',
                 note: 'محور الأمان والسيطرة والاستقرار — لما يتهدّد، الإنسان بيشدّ على المقود أكتر.' },
    vitality:  { key: 'vitality',  ar: 'الحيوية', en: 'Vitality',
                 question: 'هل أنا حيّ فعلًا؟',
                 note: 'محور النار والمعنى والحضور — لما يخبو، النجاح بيفضل والإحساس بيغيب.' },
    belonging: { key: 'belonging', ar: 'الانتماء', en: 'Belonging',
                 question: 'هل ليّ مكان حقيقي بين الناس، بكل اللي أنا هو؟',
                 note: 'محور المكان والقبول والأصالة — لما يتجرح، الإنسان بيحس بغربة وسط نجاحه.' }
  };

  /* ====================================================================
     الطرق التسعة — مصدر حقيقة واحد، مربوطة بالمحاور (٣ لكل محور)
     ----------------------------------------------------------------------
     ⚠️ ملاحظة لمحمود: ربط كل طريق بمحوره هنا اجتهاد مبدئي مبني على دلالة
     الاسم (السُّكنى/الكفاف/الحِلم ← تماسك، اليقظة/البيان/التجدّد ← حيوية،
     الميزان/التأصّل/الفيض ← انتماء). راجِعه وعدّله هنا لو حابب — كل الواجهات
     بتقرأ من المكان ده، فتعديل سطر واحد بيظبط التقرير كله.
     ==================================================================== */
  var PATHS = [
    { name: 'السُّكنى',  axis: 'cohesion' },
    { name: 'الكَفَاف',  axis: 'cohesion' },
    { name: 'الحِلم',    axis: 'cohesion' },
    { name: 'اليقظة',    axis: 'vitality' },
    { name: 'البيان',    axis: 'vitality' },
    { name: 'التجدّد',   axis: 'vitality' },
    { name: 'الميزان',   axis: 'belonging' },
    { name: 'التأصّل',   axis: 'belonging' },
    { name: 'الفيض',     axis: 'belonging' }
  ];
  function pathsForAxis(axisKey) {
    return PATHS.filter(function (p) { return p.axis === axisKey; });
  }
  ...
  /* ====================================================================
     ...
     ----------------------------------------------------------------------
     اتضاف لكل نوع:
       axis        ← محوره المركزي (يربطه بـ AXES)
       readingOpen ← مفتتح القراءة السردية في التقرير الشخصي
       axisLine    ← جملة المحور اللي ورا النمط
       firstStep   ← أول خطوة (اتجاه العلاج، مش وصفة)
     ==================================================================== */
  var TYPES = {
    burned: {
      key: 'burned',
      ...
      readingOpen: 'أقرب نمط ليك دلوقتي هو المحترق. مش معناه إنك ضعيف — معناه إن طاقتك بقت شغّالة بالخوف، وإنت بتشتري نجاحك من رصيد نفسك.',
      axisLine: 'ورا النمط ده محور التماسك — السؤال اللي شغّال تحت السطح: «هل أنا بخير وآمن؟». الخوف على موقعك هو اللي ماسك المقود.',
      firstStep: 'أول خطوة ليك مش راحة أكتر — إعادة نظر في اللي بيشغّل خوفك من الأساس.',
      color: '#ef5350'
    },
    starved: {
      key: 'starved',
      ...
      readingOpen: 'أقرب نمط ليك دلوقتي هو المجوّع. مش إنك تعبان بالضرورة — إنت فقدت النار اللي بدأت بيها، والروتين بلع المعنى من غير ما تاخد بالك.',
      axisLine: 'ورا النمط ده محور الحيوية — السؤال اللي شغّال تحت السطح: «هل أنا حيّ فعلًا؟». مش ناقصك إنجاز، ناقصك نار.',
      firstStep: 'أول خطوة ليك مش شغل أكتر — إعادة وصل بالمعنى اللي اتفقد في الزحمة.',
      color: '#ffa726'
    },
    repressed: {
      key: 'repressed',
      ...
      readingOpen: 'أقرب نمط ليك دلوقتي هو المكبوت. وصلت ونجحت، ومع ذلك جوّاك غربة وفراغ — لأن جزء منك اندفن عشان الباقي يكبر.',
      axisLine: 'ورا النمط ده محور الانتماء — السؤال اللي شغّال تحت السطح: «هل ليّ مكان حقيقي، بكل اللي أنا هو؟». نجاحك جه على حساب جزء حسّ إنه مش مرحّب بيه.',
      firstStep: 'أول خطوة ليك مش نجاح أكتر — ترجع للجزء اللي دفنته في الطريق.',
      color: '#ab8def'
    }
  };
  ...
  /* ====================================================================
     ...
     اتضاف clause ← جملة سردية للتقرير (مختلفة عن note الوصفية)
     ==================================================================== */
  var SPECTRUM = {
    balance:    { key: 'balance',    ar: 'اتزان',  en: 'Balance',
                  note: 'نجاحك وعافيتك ماشيين قريّبين من بعض. ده مكان نادر — حافظ عليه بوعي.',
                  clause: 'ونجاحك وعافيتك لسه ماشيين قريّبين من بعض — ده مكان نادر، المهم تحافظ عليه بوعي قبل ما الفجوة تفتح.' },
    excess:     { key: 'excess',     ar: 'إفراط',  en: 'Over-extension',
                  note: 'الفجوة مفتوحة وإنت بتدفع نفسك فوق طاقتك. الطاقة لسه موجودة، بس بتتحرق أسرع مما بتتجدّد.',
                  clause: 'والفجوة عندك مفتوحة وإنت بتدفع نفسك فوق طاقتك — لسه فيك طاقة، بس بتتحرق أسرع مما بتتجدّد.' },
    depletion:  { key: 'depletion',  ar: 'تفريط',  en: 'Depletion',
                  note: 'الفجوة مفتوحة والطاقة خلصت. المحرّك بيخبو — ده مش وقت دفع، ده وقت استرجاع.',
                  clause: 'والفجوة مفتوحة والطاقة خلصت — المحرّك بيخبو، وده مش وقت دفع، ده وقت استرجاع.' }
  };

  /* ====================================================================
     المستويات الثلاثة المتآكلة
     اتضاف clause ← جملة سردية للتقرير (مختلفة عن note)
     ==================================================================== */
  var LEVELS = {
    energy:       { key: 'energy',       ar: 'الطاقة',  en: 'Energy',
                    note: 'أكتر اللي متآكل عندك هو طاقتك — بتصحى مش متجدّد، والجسم بيطالبك بحقه.',
                    clause: 'وأكتر حاجة متآكلة فيك دلوقتي هي طاقتك نفسها — بتصحى مش متجدّد، والجسم بيطالبك بحقه.' },
    relationship: { key: 'relationship', ar: 'العلاقة', en: 'Engagement',
                    note: 'أكتر اللي متآكل عندك هو علاقتك بشغلك ومين حواليك — حاضر بجسمك، غايب بقلبك.',
                    clause: 'وأكتر حاجة متآكلة فيك دلوقتي هي علاقتك باللي بتعمله وبمين حواليك — حاضر بجسمك، غايب بقلبك.' },
    meaning:      { key: 'meaning',      ar: 'المعنى',  en: 'Meaning',
                    note: 'أكتر اللي متآكل عندك هو المعنى — بتنجح والإحساس مش بيمتلي. ده أهدأ مستوى وأخطره.',
                    clause: 'وأكتر حاجة متآكلة فيك دلوقتي هي المعنى — بتنجح والإحساس مش بيمتلي، وده أهدأ مستوى وأخطره لأنه بيعدّي من غير صوت.' }
  };
  ...
  /* ====================================================================
     buildReading — يركّب القراءة السردية للتقرير الشخصي من قطع المحتوى
     result = ناتج scoreDiagnostic (أو payload.result المحفوظ)
     بيرجّع: { paragraph, axisLine, firstStep, axis, axisKey, paths }
     مفيش منطق حسابي هنا — بس تجميع نصوص من مصدر الحقيقة.
     ==================================================================== */
  function buildReading(result) {
    result = result || {};
    var ty = TYPES[result.type] || {};
    var sp = SPECTRUM[result.spectrum] || {};
    var lv = LEVELS[result.erodedLevel] || {};
    var axisKey = ty.axis;
    var axis = AXES[axisKey] || {};

    var paragraph = [ty.readingOpen, sp.clause, lv.clause]
      .filter(Boolean).join(' ');

    return {
      paragraph: paragraph,
      axisLine:  ty.axisLine || '',
      firstStep: ty.firstStep || '',
      axis:      axis,
      axisKey:   axisKey,
      paths:     pathsForAxis(axisKey)
    };
  }
